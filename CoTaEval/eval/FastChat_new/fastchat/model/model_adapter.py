...
class BaseModelAdapter:
    ...
    def load_model(self, model_path: str, model_name:str, from_pretrained_kwargs: dict):
...
def load_model(
    ...
    # Load model
    model, tokenizer = adapter.load_model(model_path, model_name, kwargs)
...
class Llama2Adapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, model_name:str,from_pretrained_kwargs: dict):
        model, tokenizer = super().load_model(model_path, model_name,from_pretrained_kwargs)
        model.config.eos_token_id = tokenizer.eos_token_id
        model.config.pad_token_id = tokenizer.pad_token_id
        return model, tokenizer
